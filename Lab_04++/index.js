const Alphavit = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i',
    'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r',
    's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];
...
function TrisemysSH(key) {
    ...
    for (let i = 0; i < key.length; i++) {
        keySH[i] = (Alphavit.indexOf(key[i]) + j > Alphavit.length) ? Alphavit[Alphavit.indexOf(key[i]) + j - Alphavit.length] : Alphavit[Alphavit.indexOf(key[i]) + j];
        j++;
    }
